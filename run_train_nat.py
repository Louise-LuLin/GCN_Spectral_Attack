...
from spac.utils import calc_acc
...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='./log/nat_model_saved/', help='Directory to save the trained model.')
    ...
    path = args.model_dir + '{}_GCN.pt'.format(args.dataset)
