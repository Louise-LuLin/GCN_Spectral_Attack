...
def main():
    ...
    if args.attacker == 'random':
        ...
        attacker.attack(nat_adj, labels, perturbations)
    ...
    print(f'dataset: {args.dataset}, attacker {args.attacker}, target {args.target_node}')
    print(f'loss type: {args.loss_type}')
    print(f'perturbation rate: {args.ptb_rate}, epoch: {args.perturb_epochs}, lr: {args.att_lr}')
    print(f'weight: loss {args.loss_weight}, spac {args.spac_weight}')
    print(f'distance type: {args.distance_type}, opt type: {args.opt_type}')

    # if you want to save the modified adj/features, uncomment the code below
    if args.sanitycheck == 'yes':
        root = './sanitycheck_evasion/{}_{}_{}_{}_{}_{}lr_{}epoch_{}rate_{}spac_{}target_{}seed'
        root = root.format(args.dataset, args.distance_type, args.sample_type, 
                           args.attacker, args.loss_type, args.att_lr, args.perturb_epochs, 
                           args.ptb_rate, args.spac_weight, args.target_node, args.seed)
