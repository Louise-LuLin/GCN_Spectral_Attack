...
do
    ...
    do
        ...
        do
            python -m evasion_attack --device $cuda --dataset $dataset --loss_type ${loss} --att_lr ${lr} --perturb_epochs $ep --ptb_rate $ptb --reg_weight $reg --model_path "./nat_model_saved/${dataset}_gcn.pt" --sanitycheck no;
